...
#[inline]
pub fn inv_lerp<T>(a: T, b: T, val: T) -> T
where
    T: Float,
{
    if a == b {
...
mod test {
    ...
    #[test]
    fn inv_lerp_calc() {
        assert_eq!(inv_lerp(10.0, 20.0, 10.0), 0.0);
        assert_eq!(inv_lerp(10.0, 20.0, 20.0), 1.0);
        assert_eq!(inv_lerp(10.0, 20.0, 15.0), 0.5);
        assert_eq!(inv_lerp(10.0, 20.0, 30.0), 2.0);
        assert_eq!(inv_lerp(10.0, 20.0, 0.0), -1.0);
    }
